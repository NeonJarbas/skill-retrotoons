...
class RetroToonsSkill(OVOSCommonPlaybackSkill):
    def __init__(self, *args, **kwargs):
        ...
        self.skill_icon = self.default_bg = join(dirname(__file__), "res", "retrotoons_icon.jpg")
